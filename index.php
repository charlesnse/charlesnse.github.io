...
<meta name="keywords" content="Morgage Bank" />
<meta name="description" content="Mortgage Bank" />
<meta name="author" content="#" />
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
<title>Haggai Mortgage Bank</title>
...
<!-- fontawesome -->
<link rel="stylesheet" type="text/css" href="css/font-awesome.cs"/>
...
<!--Color Themes-->
<link id="switcher-color" href="css/default-color.css" rel="stylesheet">
                ...
                <div class="container">
                    <div class="ttm-topbar-content">
                        <ul class="top-contact text-left">
                            <li class="list-inline-item">News Feed</li>
                        </ul>
                        <div class="topbar-right text-right">
                            ...
                            <ul class="top-contact ttm-highlight">
                                <li><strong><i class="fa fa-phone"></i>Talk To Expert :</strong> <span class="tel-no">07045994847</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="ttm-top-info-con clearfix">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="title-box">
                                        <h5>Address</h5> 
                                        <p>Km 46 Lagos Ibadan Express Way</p>   
                                    </div>
                                </li>     
                            </ul>
                        </div>
                                ...
                                <div class="site-header-menu-inner ttm-stickable-header">
                                    ...
                                    <div id="site-navigation" class="site-navigation">
                                        ...
                                        <nav id="menu" class="menu">
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="#">Mortgage Product</a>
                                                    <ul>
                                                        <li><a href="#">Haggai Plot Advance (HAPA)</a></li>
                                                        <li><a href="#">Haggai House Completion (HAHCOM)</a></li>
                                                        <li><a href="#">Haggai RENOVATION (HAREL)</a></li>
                                                        <li><a href="#">Haggai HOUSE PURCHASE (HAHP)</a></li>
                                                        <li><a href="#">Haggai RENT (HARENT)</a></li>
                                                        <li><a href="#">Haggai CAMP HOME</a></li>
                                                        <li><a href="#">MY OWN HOME</a></li>
                                                       
                                                    </ul>
                                                </li>
                                                <li><a href="element.html">Careers</a></li>
                                                <li><a href="element.html">Financed Project</a></li>
                                                <li><a href="element.html">Resources</a></li>
                                                <li><a href="element.html">Contact</a></li>
                                    ...
                                    <div class="ttm-rt-contact">
                                        ...
                                        <div class="ttm-custombutton">
                                            <a href="contact-us.html">ONLINE BANKING<i class="fa fa-caret-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" data-version="5.4.8">
                ...
                <ul>
                    ...
                    <li data-index="rs-11" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <img src="images/slide2.jpg" alt="" title="slider-mainbg-002" width="1920" height="725" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        ...
                        <div class="tp-caption desc-slide" id="slide-11-layer-22" data-x="['left','left','left','center']" data-hoffset="['50','40','30','0']" data-y="['middle','middle','middle','middle']" data-voffset="['90','90','44','21']"
                            ...
                            data-paddingright="[0,0,0,0]"
                            data-paddingbottom="[0,0,0,0]"
                            data-paddingleft="[0,0,0,0]">Our objective of assist our customers to be proud owners oflanded properties <br>in prime locations which a view of building such eventually. .
                        ...
                        <a class="tp-caption classic-border-button " href="#" target="_self" id="slide-1-layer-18" data-x="['left','left','left','center']" data-hoffset="['50','40','30','0']" data-y="['middle','middle','middle','middle']" data-voffset="['190','190','124','72']"
                            ...
                            data-paddingleft="[30,30,25,20]">More products
                        </a>

                        <a class="tp-caption video-icon ttm_prettyphoto" href="https://www.youtube.com/watch?v=9ATUDsbomhA" target="_self" id="slide-11-layer-13" data-x="['left','left','center','center']" data-hoffset="['249','240','-156','45']" data-y="['middle','middle','middle','middle']" data-voffset="['190','190','124','115']"
                    ...
                    <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <img src="images/slider1.jpg" alt="" title="slider-mainbg-001" width="1920" height="725" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        ...
                        <div class="tp-caption haeding-slide" id="slide-3-layer-5" data-x="['right','right','right','center']" data-hoffset="['50','40','30','0']" data-y="['top','top','top','middle']" data-voffset="['179','179','51','-90']"
                            ...
                            data-paddingright="[0,0,0,0]"
                            data-paddingbottom="[0,0,0,0]"
                            data-paddingleft="[0,0,0,0]">Personal
                        </div>
                        <div class="tp-caption haeding-slide" id="slide-3-layer-6" data-x="['right','right','right','center']" data-hoffset="['50','50','30','0']" data-y="['top','top','top','middle']" data-voffset="['265','265','113','-39']"
                            ...
                            data-paddingbottom="[0,0,0,0]"
                            data-paddingleft="[0,0,0,0]">
                            Loan For <strong>Needs</strong></div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="about-img about-2 mb-10">
                            <img class="img-fluid" src="images/table.jpg" alt="about-img">
                    ...
                    <div class="col-lg-6">
                        <div class="about-info pr-10 res-1199-plr-0">
                            ...
                            <div class="section-title clearfix">
                                <h5>HAGGAI</h5>
                                <h2 class="title">Why<strong>we are Unique</strong></h2>
                                <div class="heading-seperator"><span></span></div>
                                <p><strong>We have set up a framework that will revamp the housing finance sector and also make access to housing finance a lot easier through the following components</strong></p>
                                <p>Nigeria Mortgage Refinance Company (NMRC): Providing long-term refinancing of mortgages and standardizing mortgage procedures.

Mortgage Guarantee Scheme: Through this scheme, borrowers with insufficient or no equity contribution (initial down payment) can access mortgage for home ownership.

Housing Microfinance Scheme: Would stimulate increased lending to low-income earners in the formal and informal sectors in Nigeria through Microfinance Banks for incremental housing construction or housing improvement.</p>
                            </div><!-- section title end -->
                            <!-- row-->
                            <div class="row">
                                <div class="col-lg-8">
                                   <h4>We have years of experience to give you better results.</h4>
                                </div>
                        ...
                        <div class="about-content ttm-col-bgcolor-yes ttm-bg ttm-left-span ttm-bgcolor-darkgrey padding-1">
                            ...
                            <div class="layer-content">
                                ...
                                <div class="section-title clearfix">
                                    ...
                                    <h2 class="title">Open an account <strong>with Haggai</strong></h2>
                                    <div class="heading-seperator"><span></span></div>
                                    <p>Understand what is the loan amount you are eligible for and what would the EMI be.you can apply as per your eligibility.</p>
                                </div><!-- section title end -->
                                ...
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" href="#">OPEN ACCOUNT</a>
                                </div><!-- row end-->
                            </div>
                            ...
                            <div class="layer-content">
                                ...
                                <div class="image-overlay-content">
                                    <div class="rectangle-shape ttm-bottom-view-overlay ttm-bgcolor-skincolor">
                                        ...
                                        <p>Haggai has years of experience with providing wide area of specialty services within and outside our work scope.  </p>
                                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="pt-100 row-title text-center res-991-pt-0">
                            <div class="ttm-video-btn btn-size-sm mb-55 mt-30">
                                <a class="ttm-play-btn ttm_prettyphoto" href="https://www.youtube.com/watch?v=9ATUDsbomhA"><span class="ttm-btn-play"><i class="fa fa-play"></i></span></a>
                            </div>
                            <!-- section title -->
                            <div class="section-title clearfix">
                                <h2 class="title">Earn Interest</h2>
                                <h2 class="title">On <strong>Your Funds </strong></h2>
                                <p>We believe strongly that we can and must do things differently.<br>Our aim is to bring happines to every home</p>
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" href="#">Send a message</a>
                            </div><!-- section title end -->
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="section-title style2 clearfix">
                            <h2 class="title">Take a look <strong>at our mortgage product</strong></h2>
                            <p>Haggai has years of experience with providing wide area of specialty services works listed below.</p>
                        </div><!-- section-title end -->
                    </div>
                    <div class="col-lg-3 col-md-12">
                        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-border ttm-btn-color-black mt-30 mb-35 res-991-mt-0 float-right" href="#">Completed Project</a>
                    </div>
                </div><!-- row end -->
                <!-- row -->
                <div class="row pt-10 pl-5 pr-5 res-991-mt-0 multi-columns-row ttm-boxes-spacing-10px ttm-bgcolor-white box-shadow">
                    <div class="ttm-box-col-wrapper col-lg-4 col-md-6">
                        ...
                        <div class="featured-item featured-portfolio-item">
                            <div class="featured-thumbnail">
                                <a href="#"> <img class="img-fluid" src="images/2.jpg" alt="image"></a>
                            </div>
                            <!-- ttm-box-view-overlay -->
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                               
                                <div class="content-post content-portfolio-post">
                                    <h2 class="title-post"><a href="portfolio-details-01.html">Haggai Plot Advance</a></h2>
                                    <span class="category">
                                        <a href="#">The product is designed with the objective of assisting our customers....read more </a>
                    ...
                    <div class="ttm-box-col-wrapper col-lg-4 col-md-6">
                        ...
                        <div class="featured-item featured-portfolio-item">
                            <div class="featured-thumbnail">
                                <a href="#"> <img class="img-fluid" src="images/3.jpg" alt="image"></a>
                            </div>
                            <!-- ttm-box-view-overlay -->
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                
                                <div class="content-post content-portfolio-post">
                                    <h2 class="title-post"><a href="portfolio-details-02.html">Haggai House Completion</a></h2>
                                    <span class="category">
                                        <a href="#">Designed to assist our customers who have commenced construction projects.........read more </a>
                                    </span>
                                </div>
                            </div><!-- ttm-box-view-overlay end-->
                        </div><!-- featured-item -->
                    ...
                    <div class="ttm-box-col-wrapper col-lg-4 col-md-6">
                        ...
                        <div class="featured-item featured-portfolio-item">
                            <div class="featured-thumbnail">
                                <a href="#"> <img class="img-fluid" src="images/6.jpg" alt="image"></a>
                            </div>
                            <!-- ttm-box-view-overlay -->
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                
                                <div class="content-post content-portfolio-post">
                                    <h2 class="title-post"><a href="portfolio-details-03.html">Haggai Renovation</a></h2>
                                    <span class="category">
                                        <a href="portfolio-category.html">Designed to assist our customers in renovating their properties......read more</a>
                                    </span>
                                </div>
                            </div><!-- ttm-box-view-overlay end-->
                        </div><!-- featured-item -->
                    ...
                    <div class="ttm-box-col-wrapper col-lg-4 col-md-6">
                        ...
                        <div class="featured-item featured-portfolio-item">
                            <div class="featured-thumbnail">
                                <a href="#"> <img class="img-fluid" src="images/4.jpg" alt="image"></a>
                            </div>
                            <!-- ttm-box-view-overlay -->
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                               
                                <div class="content-post content-portfolio-post">
                                    <h2 class="title-post"><a href="portfolio-details-01.html">Haggai Purchase</a></h2>
                                    <span class="category"><a href="portfolio-category.html">The products is designed to enable prospective home owners achieve their dreams....read more</a></span>
                                </div>
                            </div><!-- ttm-box-view-overlay end-->
                        </div><!-- featured-item -->
                    </div>
                    <div class="ttm-box-col-wrapper col-lg-4 col-md-6">
                        ...
                        <div class="featured-item featured-portfolio-item">
                            <div class="featured-thumbnail">
                                <a href="#"><img class="img-fluid" src="images/1.jpg" alt="image"></a>
                            </div>
                            <!-- ttm-box-view-overlay -->
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                               
                                <div class="content-post content-portfolio-post">
                                    <h2 class="title-post"><a href="portfolio-details-02.html">Haggai Rent</a></h2>
                                    <span class="category"><a href="portfolio-category.html">Designed to assist our customers in paying their ever increasing house rent with ease.....read more</a></span>
                                </div>
                            </div><!-- ttm-box-view-overlay end-->
                        </div><!-- featured-item -->
                    </div>
                    <div class="ttm-box-col-wrapper col-lg-4 col-md-6">
                        ...
                        <div class="featured-item featured-portfolio-item">
                            <div class="featured-thumbnail">
                                <a href="#"> <img class="img-fluid" src="images/5.jpg" alt="image"></a>
                            </div>
                            <!-- ttm-box-view-overlay -->
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                
                                <div class="content-post content-portfolio-post">
                                    <h2 class="title-post"><a href="portfolio-details-03.html">Haggai Camp Home</a></h2>
                                    <span class="category"><a href="portfolio-category.html">Designed in order to make home ownership dreams of the members of the mission(RCCG) on the camp ground possible.....read more</a></span>
                                </div>
                            </div><!-- ttm-box-view-overlay end-->
                        </div><!-- featured-item -->
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-4 widget-area">  
                       <div class="widget widget-out-link clearfix">
                            <i class="fa fa-phone"></i>
                            <h3 class="widget-title" style="color:#e6beac">Have a question? call us now</h3>
                            <p>Office 1: 07045994840<br>Office 2: 01-2957794-5</p>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 widget-area">  
                       <div class="widget widget-out-link clearfix">
                       <i class="fas fa-envelope-square"></i>
                            <h3 class="widget-title" style="color:#e6beac">Need support? Drop us an email</h3>
                            <p>info@haggaibank.com<br>support@haggaibank.com</p>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 widget-area">
                        ...
                        <i class="fas fa-clock"></i>
                            <h3 class="widget-title" style="color:#e6beac">Find Us</h3>
                            <p>119, Bode Thomas Street<br>
            ...
            <div class="container">
                <div class="row copyright">
                    <div class="col-md-6">
                        ...
                        <span>Copyright © 2019&nbsp;<a href="#">Haggai Bank</a>. All rights reserved.</span></div>
                    </div>
